...
function buttons:CombatButton(ModuleName, Call)
  ...
  Button.Position = UDim2.new(-0.337500036, 0, 0.0131499358, 0)
  Button.Size = UDim2.new(0, 131, 0, 32)
...
function buttons:MovementButton(ModuleName, Call)
...
function buttons:UtilityButton(ModuleName, Call)
...
function buttons:VisualsButton(ModuleName, Call)
